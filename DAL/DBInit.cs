...
public static class DBInit
{
    public static void Seed(IApplicationBuilder app)
    {
        ...
        context.Database.EnsureDeleted(); //this always deletes the existing database 
        context.Database.EnsureCreated(); //this creates it again from screat

        if (!context.Items.Any()) //means "if there are no items in the database yet"
        {
            var items = new List<Item> //then we create the Item items. Item list of initialisation:
            {
                new Item
                {
                    Name = "Pizza",
        ...
        //context is the database. It's the instance of the ItemDbContext we use in this class
